    ...
    <nav className="shadow-md w-full fixed top-0 left-0 bg-secondaryDark">
      <div className=" items-center flex flex-wrap mx-7 justify-between py-4">
        ...
        <button
          ...
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-primaryDark focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
